...
namespace Auction_Prop_API.Controllers.MVC
{
    public class RegisteredBuyersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserId,FirstName,LastName,IDNumber,DateOfBirth,BondedOrCash,ProofOfResidencePath,CopyOfIDPath,ProfilePhotoPath,ApprovalStatus,RegistrationDate,Signiture")] RegisteredBuyer registeredBuyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserId,FirstName,LastName,IDNumber,DateOfBirth,BondedOrCash,ProofOfResidencePath,CopyOfIDPath,ProfilePhotoPath,ApprovalStatus,RegistrationDate,Signiture")] RegisteredBuyer registeredBuyer)
        {
            if (ModelState.IsValid)
            {
